        ...
        <div className=" max-w-xl flex-shrink-0 w-full">
          ...
          <form onSubmit={handleLogin} className="card-body">
            ...
            <div className="form-control mt-6">
              <button className="py-3 text-2xl font-serif bg-black text-white hover:bg-slate-600">Login</button>
            </div>
          </form>
          <div onClick={handleSignInGoogle} className=" cursor-pointer max-w-3xl mx-auto flex  justify-center items-center">
            ...
            <div className="text-center">
                  ...
                  You are not part of <span className="font-semibold font-serif">Lartisien</span> ?
